...
public class DatabaseConstants {
    ...
    public static final String SQL_SELECT_VAULT_BY_OWNER = "SELECT `id`, `size` FROM `%s` WHERE `owner_uuid` = ?";
    public static final String SQL_SELECT_VAULT_CONTENTS_BY_ID = "SELECT `contents` FROM `%s` WHERE `id` = ?";
